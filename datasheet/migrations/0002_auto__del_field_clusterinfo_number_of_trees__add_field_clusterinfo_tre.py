...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClusterInfo.number_of_trees'
        db.delete_column(u'datasheet_clusterinfo', 'number_of_trees')

        # Adding field 'ClusterInfo.tree_ID'
        db.add_column(u'datasheet_clusterinfo', 'tree_ID',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ClusterInfo.number_of_trees'
        db.add_column(u'datasheet_clusterinfo', 'number_of_trees',
                      self.gf('django.db.models.fields.IntegerField')(default=''),
                      keep_default=False)

        # Deleting field 'ClusterInfo.tree_ID'
        db.delete_column(u'datasheet_clusterinfo', 'tree_ID')
