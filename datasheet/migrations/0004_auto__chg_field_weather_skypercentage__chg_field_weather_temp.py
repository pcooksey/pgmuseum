...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Weather.skypercentage'
        db.alter_column(u'datasheet_weather', 'skypercentage', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Weather.temp'
        db.alter_column(u'datasheet_weather', 'temp', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Weather.skypercentage'
        db.alter_column(u'datasheet_weather', 'skypercentage', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Weather.temp'
        db.alter_column(u'datasheet_weather', 'temp', self.gf('django.db.models.fields.IntegerField')())
