...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Weather.wind'
        db.alter_column(u'datasheet_weather', 'wind', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'ClusterInfo.height'
        db.alter_column(u'datasheet_clusterinfo', 'height', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Weather.wind'
        db.alter_column(u'datasheet_weather', 'wind', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ClusterInfo.height'
        db.alter_column(u'datasheet_clusterinfo', 'height', self.gf('django.db.models.fields.IntegerField')())
