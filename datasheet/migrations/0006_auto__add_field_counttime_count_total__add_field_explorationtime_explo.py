...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountTime.count_total'
        db.add_column(u'datasheet_counttime', 'count_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ExplorationTime.exploration_total'
        db.add_column(u'datasheet_explorationtime', 'exploration_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Observed.observed_total'
        db.add_column(u'datasheet_observed', 'observed_total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CountTime.count_total'
        db.delete_column(u'datasheet_counttime', 'count_total')

        # Deleting field 'ExplorationTime.exploration_total'
        db.delete_column(u'datasheet_explorationtime', 'exploration_total')

        # Deleting field 'Observed.observed_total'
        db.delete_column(u'datasheet_observed', 'observed_total')
    ...
    models = {
        ...
        u'datasheet.counttime': {
            ...
            'count_total': ('django.db.models.fields.IntegerField', [], {}),
        ...
        u'datasheet.explorationtime': {
            ...
            'end': ('django.db.models.fields.TimeField', [], {}),
            'exploration_total': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start': ('django.db.models.fields.TimeField', [], {}),
            'total': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        u'datasheet.observed': {
            ...
            'observed_total': ('django.db.models.fields.IntegerField', [], {}),
        ...
        u'datasheet.weather': {
            ...
            'skypercentage': ('django.db.models.fields.CharField', [], {'default': "'0-25%'", 'max_length': '10'}),
            'temp': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
            'wind': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
