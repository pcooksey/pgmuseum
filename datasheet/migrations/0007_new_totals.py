...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
		...
		for data in orm.ExplorationTime.objects.all():
			data.exploration_total = data.total
			data.save()
		for data in orm.CountTime.objects.all():
			data.count_total = data.total
			data.save()
		for data in orm.Observed.objects.all():
			total = data.loners + data.sunners + data.fliers + data.grounders + data.dead + data.mating
			data.observed_total = total
			data.save()
