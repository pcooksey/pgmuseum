...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CountTime.total'
        db.delete_column(u'datasheet_counttime', 'total')

        # Deleting field 'ExplorationTime.total'
        db.delete_column(u'datasheet_explorationtime', 'total')

        # Deleting field 'Observed.total'
        db.delete_column(u'datasheet_observed', 'total')


    def backwards(self, orm):
        # Adding field 'CountTime.total'
        db.add_column(u'datasheet_counttime', 'total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ExplorationTime.total'
        db.add_column(u'datasheet_explorationtime', 'total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Observed.total'
        db.add_column(u'datasheet_observed', 'total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
