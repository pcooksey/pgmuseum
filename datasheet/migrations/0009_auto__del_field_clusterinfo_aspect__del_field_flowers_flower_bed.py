...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClusterInfo.aspect'
        db.delete_column(u'datasheet_clusterinfo', 'aspect')
    ...
    def backwards(self, orm):
        # Adding field 'ClusterInfo.aspect'
        db.add_column(u'datasheet_clusterinfo', 'aspect',
