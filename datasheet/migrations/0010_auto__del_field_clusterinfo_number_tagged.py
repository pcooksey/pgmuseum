...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClusterInfo.number_tagged'
        db.delete_column(u'datasheet_clusterinfo', 'number_tagged')


    def backwards(self, orm):
        # Adding field 'ClusterInfo.number_tagged'
        db.add_column(u'datasheet_clusterinfo', 'number_tagged',
