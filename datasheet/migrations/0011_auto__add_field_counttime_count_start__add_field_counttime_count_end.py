...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountTime.count_start'
        db.add_column(u'datasheet_counttime', 'count_start',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'CountTime.count_end'
        db.add_column(u'datasheet_counttime', 'count_end',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CountTime.count_start'
        db.delete_column(u'datasheet_counttime', 'count_start')

        # Deleting field 'CountTime.count_end'
        db.delete_column(u'datasheet_counttime', 'count_end')
    ...
    models = {
        ...
        u'datasheet.counttime': {
            ...
            'count_end': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            'count_start': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
        ...
        u'datasheet.weather': {
            ...
            'winddirection': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '20'})
        }
    }
