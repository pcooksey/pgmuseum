...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CountTime.end'
        db.delete_column(u'datasheet_counttime', 'end')

        # Deleting field 'CountTime.start'
        db.delete_column(u'datasheet_counttime', 'start')


    def backwards(self, orm):
        # Adding field 'CountTime.end'
        db.add_column(u'datasheet_counttime', 'end',
                      self.gf('django.db.models.fields.TimeField')(default=''),
                      keep_default=False)

        # Adding field 'CountTime.start'
        db.add_column(u'datasheet_counttime', 'start',
                      self.gf('django.db.models.fields.TimeField')(default=''),
                      keep_default=False)
